...
def parse_args(args_list=None):
    ...
    parser.add_argument(
        'experiment',
        choices=['driving_carla', 'driving_carla_multi', 'driving_gazebo'],
        help='name of experiment, possible: driving_carla, driving_carla_multi, driving_gazebo',
        type=str)
    parser.add_argument(
        '--network_name',
    ...
    parser.add_argument(
        ...
        type=str,
        default='',
        help='root path of the dataset; for driving_carla_multi this is the '
             'directory containing the scenario subfolders'
    )
    parser.add_argument(
        '--carla_test_scenario',
        type=str,
        default=None,
        help='name of the driving_carla_multi scenario subfolder held out '
             'as the global test set; defaults to the last one found '
             '(sorted) under --data_path'
    )
    parser.add_argument(
        "--network_backend",
        type=str,
    ...
    parser.add_argument(
        '--architecture',
        choices=['ring','grid','tree', 'sfl'],
        help='architecture to use, possible: ring, grid, tree, sfl(server-based federated learning)',
        default='ring'
    )
    parser.add_argument(
        '--model',
